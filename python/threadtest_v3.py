...
def talker2(x,y,rikirobot,RotationAngle):
...
def decodeDisplay(image):
    ...
    for barcode in barcodes:
        ...
        cutImage = image[x-100:x+w+100,y-100:y+h+100]    #对图像进行剪裁
        ...
        if realPosition[0] > -1:
          print("rikirobot:",rikirobot)
          print("realPosition:",realPosition)
          print("RotationAngle:",RotationAngle)
        #talker(x,y,barcodeData)
          talker2(realPosition[0],realPosition[1],rikirobot,RotationAngle)
        #print("#####################")
    # return image
